  ...
  <div class="login-box">
    ...
    <div class="card">
      ...
      <div class="card-body login-card-body">
        ...
        <form action="/authorization/simpan" method="post">
          ...
          <div class="d-flex justify-content-between">
            <div>
              <a href="<?= base_url()?>/masuk" type="submit" class="btn btn-secondary btn-block" style="margin-top: 0 !important ;">Kembali</a>
            </div>
              <div>
